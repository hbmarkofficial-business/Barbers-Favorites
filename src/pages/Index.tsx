  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | Barbers Favorites</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Barbers Favorites in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Barbers Favorites | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Barbers Favorites | Premium Barbershop Berlin" />
        <meta
